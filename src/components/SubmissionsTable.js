...
const SubmissionsTable = () => {
    ...
    function handleSubmissionModal(submissionId){
        ...
        axios.get("http://localhost:8081/api/v1/submission-code?submissionID=" + submissionId).then((res) => {
    ...
    useEffect(() => {
     try {
        axios.get("http://localhost:8081/api/v1/submissions?userID=" + "USER1").then((res) => {
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            <div className="ml-4">
                              ...
                              <button
                                   onClick={() => handleSubmissionModal(submission.submissionId)  }
                          >
